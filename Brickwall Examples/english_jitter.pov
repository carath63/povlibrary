/******************************************************************************
 * File: english_jitter.pov
 * Description:
 *      Example of the Brickwall system using an English layout with jitter
 ******************************************************************************/
...
#macro Scene_default_object()
    ...
    #local _layout.layout_jitter        = Common_jitter(_layout);
    
    #local _bricks_shape_fn = Brickwall_english_bricks_shape_fn(_layout,Scene_brick_shape)
    #local _mortar_block    = Brickwall_english_mortar_block_create(_layout,Common_jitter_size.z)
    #local _mortar_shape_fn = Brickwall_english_mortar_shape_fn(_layout,_mortar_block,Common_mortar_joint_spec,_bricks_shape_fn)
    
    #local _lbounds         = <0,0,0> - Common_jitter_size;
    #local _ubounds         = _layout.wall_sz + Common_jitter_size;
