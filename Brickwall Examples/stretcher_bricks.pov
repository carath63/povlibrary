...
#include "brickwall_stretcher_layout.inc"
#include "common.inc"
...
#declare Scene_View = 1.1;
    ...
    #declare Scene_wall_halfbricks  = 1;
#end
...
#end
#ifndef (Scene_wall_raking)
    #declare Scene_wall_raking      = 0;    // Can be any value between 0 and 1; shifts the main stretcher row by a fraction of a brick
#end
...
#macro Scene_default_object()
    ...
    #local _layout                      = Brickwall_stretcher_layout_create(_wall_spec,Common_brick_spec,Scene_wall_parity,Scene_wall_raking);
    
    #local _bricks_shape_fn = Brickwall_stretcher_bricks_shape_fn(_layout,Scene_brick_shape)
    #local _mortar_block    = Brickwall_stretcher_mortar_block_create(_layout,Scene_mortar_inset)
    #local _mortar_shape_fn = Brickwall_stretcher_mortar_shape_fn(_layout,_mortar_block,Common_mortar_joint_spec,_bricks_shape_fn)
